        ...
        <div className="flex flex-col lg:flex-row items-center justify-center gap-12 lg:gap-20">
          ...
          <div className="flex-1 w-full max-w-[640px] space-y-7">
            ...
            >
              ...
              இந்த இலவச மாஸ்டர்கிளாஸ் சுமார் <span className="text-yellow-400">90 நிமிட</span> நிமிடங்கள் நடைபெறும். இதில், ஏன் <span className="text-yellow-400">AI</span> மற்றும் <span className="text-yellow-400">Data Analyst</span> உங்கள் எதிர்கால தொழில் என்று தேர்வு செய்ய வேண்டும் என்பதையும், <span className="text-yellow-400">BM Academy</span> உங்கள் பயணத்தை எவ்வாறு வெற்றிகரமாக மாற்றுகிறது என்பதையும் விரிவாக விளக்கும்.
            ...
            >
              <p className="text-neutral-300 text-sm md:text-base leading-relaxed font-medium">
               பங்கேற்பாளர்கள் நேரடி AI கருவிகள் டெமோவை காணலாம் மற்றும் நேரடி கேள்வி பதில் அமர்வில் தங்கள் சந்தேகங்களை தீர்க்கலாம்
              </p>
            </motion.div>
              ...
              <div className="p-6 space-y-6 relative">
                ...
                <div className="space-y-2 font-mono text-xs md:text-sm">
                  <div className="flex gap-2">
                    ...
                    <span className="text-yellow-300">"Master Data Analyst"</span>;
                  </div>
                  <div className="flex gap-2">
                    <span className="text-purple-400">const</span>
