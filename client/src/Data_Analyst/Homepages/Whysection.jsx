  ...
  const benefits = [
    {
      ...
      description: "Learn why AI + Data Analytics is the hottest career right now—with endless job opportunities locally and globally."
    },
    {
      id: 2,
    ...
    },
    {
      ...
      description: "Hear how BM Academy has helped hundreds of students get placed and start thriving careers."
    },
    {
      id: 4,
      icon: <Lightbulb className="w-8 h-8 text-white" />,
      title: "Experience a Live Demo",
      description: "Watch AI tools in action and see how data analytics can solve real business problems."
    },
    {
      id: 5,
