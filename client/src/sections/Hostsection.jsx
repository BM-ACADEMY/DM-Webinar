    ...
    <div id="host" className="px-4 md:px-12 lg:px-20 xl:px-32 mt-0 pb-10 overflow-x-hidden">
      <SectionTitle
        ...
        text2={
          <>
            Meet Your Host –{" "}
            <span className="text-yellow-500">Kamarudeen BM</span>
          </>
        }
        text3={
          <>
            Founder of spanc <span className="text-yellow-500">ABM Groups</span>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 lg:gap-16 items-start mt-16">
        ...
        >
          {/* --- UPDATED: Name Highlighted --- */}
          <p className="text-slate-300 text-base sm:text-lg leading-relaxed">
            <span className="text-yellow-500 font-bold">Kamarudeen BM</span> is
            the founder of <span className="text-yellow-500">ABM Groups</span>{" "}
            in Puducherry. He has built multiple brands across education, tech,
            food, travel, and real estate using digital marketing, systems and
            AI.
          </p>
          ...
          <div className="space-y-4">
            {journeyPoints.map((point, index) => (
              ...
              >
                {/* Added mt-1 to align icon with the first line of text perfectly */}
                <AiOutlineCheckCircle className="text-yellow-500 text-2xl flex-shrink-0 mt-1" />
          ...
          >
            In this webinar, he will share the same mindset, tools, and roadmap
            he uses in his own businesses — so you can start your AI + Digital
            Marketing journey with clarity and confidence.
          </motion.p>
        </motion.div>
      </div>
