    ...
    return (
        <footer className="flex flex-wrap justify-between overflow-hidden gap-10 md:gap-20 mt-40 py-6 px-6 md:px-16 lg:px-24 xl:px-32 text-[13px] text-gray-500">
            ...
            <motion.div className="flex flex-col max-md:items-center max-md:text-center gap-2 items-end"
                ...
                transition={{ type: "spring", stiffness: 280, damping: 70, mass: 1 }}
            >
                <p className="max-w-60">Socialmedia</p>
                <div className="flex items-center gap-4 mt-3">
                    <a href="" target="_blank" rel="noreferrer">
                        <DribbbleIcon className="size-5 hover:text-yellow-500" />
                    </a>
                    <a href="https://www.linkedin.com/company/bm-academypondy/about/?viewAsMember=true" target="_blank" rel="noreferrer">
                        <LinkedinIcon className="size-5 hover:text-yellow-500" />
                    </a>
                    <a href="https://x.com/BMACADEMYPONDY" target="_blank" rel="noreferrer">
